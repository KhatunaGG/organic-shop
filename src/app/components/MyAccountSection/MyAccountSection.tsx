...
//   const isMyAccountPage = path.includes("myAccount");
//   console.log(isMyAccountPage, "isMyAccountPage")
...
//   const { accessToken, edit, setEdit, editInvoice } = context;
...
const MyAccountSection = () => {
  ...
  if (!context) return null;
  const { accessToken, edit, setEdit, editInvoice, setAllInvoices, allInvoices } = context;
